  ...
  "node_modules/multicodec/src/index.js"(exports, module) {
    ...
    function addPrefix(multicodecStrOrCode, data) {
      ...
      if (multicodecStrOrCode instanceof Uint8Array) {
        prefix2 = util.varintUint8ArrayEncode(multicodecStrOrCode);
      } else {
...
async function fetchPublishedContractFromPolygon(publisherAddress, contractName) {
  ...
  const ContractPublisherAbi = (await import("./ContractPublisher-YKLFSWE4.js")).default;
...
async function getPrebuiltInfo(address, provider2) {
  try {
    const IThirdwebContractABI = (await import("./IThirdwebContract-AFCZ52PN.js")).default;
...
async function getMetadataUriFromMultichainRegistry(address, chainId, sdkOptions) {
  var _a;
  const TWRegistryABI = (await import("./TWMultichainRegistryLogic-BZRVLHN5.js")).default;
...
Expected function signature: ${functions[0].signature}`);
  ...
  async enginePrepareRequest(transaction) {
    ...
    if (transaction.functionName === "approve" && transaction.functionArgs.length === 2) {
      ...
      const ForwarderABI = (await import("./Forwarder-LCWTZD5S.js")).default;
...
var EditionDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [abi, contract, _network] = await Promise.all([EditionDropInitializer.getAbi(address, provider2, storage), import("./edition-drop-294e1578.browser.esm-ULVZDFJ2.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return !contractInfo || contractInfo.version > 2 ? (await import("./DropERC1155-UPF5J7WV.js")).default : (await import("./DropERC1155_V2-EETMXMPH.js")).default;
  }
};
var EditionInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([EditionInitializer.getAbi(address, provider2, storage), import("./edition-1ccecf2c.browser.esm-YLKUSXTF.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./TokenERC1155-ASJ73ZCZ.js")).default;
  }
};
var MarketplaceInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceInitializer.getAbi(address, provider2, storage), import("./marketplace-2e2adc0e.browser.esm-352XY52F.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./Marketplace-HQATLBE5.js")).default;
  }
};
var MarketplaceV3Initializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceV3Initializer.getAbi(address, provider2, storage, options), import("./marketplacev3-ef469d89.browser.esm-LQTTUXQW.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage, options) => {
    ...
    const localAbi = (await import("./MarketplaceV3-3AW2UWUH.js")).default;
...
var MultiwrapInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MultiwrapInitializer.getAbi(address, provider2, storage), import("./multiwrap-2e713f6c.browser.esm-GWEPR7KF.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./Multiwrap-YSEPX3J5.js")).default;
  }
};
var NFTCollectionInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTCollectionInitializer.getAbi(address, provider2, storage), import("./nft-collection-5b9d9850.browser.esm-RNAM3ZCM.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./TokenERC721-6BJKMVU2.js")).default;
  }
};
var NFTDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTDropInitializer.getAbi(address, provider2, storage), import("./nft-drop-ee9ded99.browser.esm-HJAW76C6.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    const contractInfo = await getContractInfo(address, provider2);
    return !contractInfo || contractInfo.version > 3 ? (await import("./DropERC721-RWUGH7EP.js")).default : (await import("./DropERC721_V3-YIHOWGKM.js")).default;
  }
};
var PackInitializer = {
  name: "Pack",
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([PackInitializer.getAbi(address, provider2, storage), import("./pack-02f90278.browser.esm-APXVANDH.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return AbiSchema.parse((await import("./Pack-F7FOOKI4.js")).default || []);
  }
};
var SignatureDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SignatureDropInitializer.getAbi(address, provider2, storage), import("./signature-drop-266c8004.browser.esm-JWY77QQH.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    const contractInfo = await getContractInfo(address, provider2);
    return !contractInfo || contractInfo.version > 4 ? (await import("./SignatureDrop-ESXTPAUV.js")).default : (await import("./SignatureDrop_V4-A5JTNTLA.js")).default;
  }
};
var SplitInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SplitInitializer.getAbi(address, provider2, storage), import("./split-eb66a32f.browser.esm-KFMTCGIC.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./Split-T5O4ETDG.js")).default;
  }
};
var TokenDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenDropInitializer.getAbi(address, provider2, storage), import("./token-drop-889631f7.browser.esm-DJKCV6UE.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    const contractInfo = await getContractInfo(address, provider2);
    return !contractInfo || contractInfo.version > 2 ? (await import("./DropERC20-RYWKIXZH.js")).default : (await import("./DropERC20_V2-V5Z3UEPN.js")).default;
  }
};
var TokenInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenInitializer.getAbi(address, provider2, storage), import("./token-1e82c71a.browser.esm-CGWX2ILS.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./TokenERC20-HC6FFIKJ.js")).default;
  }
};
var VoteInitializer = {
  name: "VoteERC20",
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([VoteInitializer.getAbi(address, provider2, storage), import("./vote-e5646e80.browser.esm-RLRRN6TB.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./VoteERC20-3WFOLSAW.js")).default;
  }
};
...
@thirdweb-dev/crypto/dist/thirdweb-dev-crypto.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-IEERL7KR.js.map
