import {
  require_js,
  require_sha
} from "./chunk-W7PRLLFR.js";
import {
  require_semver
} from "./chunk-Y2FGUPUS.js";
import "./chunk-JBULUTXB.js";
import {
  require_events
...
function P() {
  ...
  for (i.sort(e); n2 = i.shift(); )
    n2.__d && (u3 = i.length, r4 = void 0, f3 = (o3 = (t3 = n2).__v).__e, c3 = [], s3 = [], t3.__P && ((r4 = w({}, o3)).__v = o3.__v + 1, l.vnode && l.vnode(r4), j(t3.__P, r4, o3, t3.__n, t3.__P.namespaceURI, 32 & o3.__u ? [f3] : null, c3, null == f3 ? C(o3) : f3, !!(32 & o3.__u), s3), r4.__v = o3.__v, r4.__.__k[r4.__i] = r4, z(c3, r4, s3), r4.__e != f3 && S(r4)), i.length > u3 && i.sort(e));
  P.__r = 0;
}
function $(n2, l3, u3, t3, i3, r4, o3, e3, f3, c3, s3) {
  ...
  for (f3 = I(u3, l3, g3, f3, m3), a3 = 0; a3 < m3; a3++)
    null != (y3 = u3.__k[a3]) && (h3 = -1 === y3.__i ? p : g3[y3.__i] || p, y3.__i = a3, _3 = j(n2, y3, h3, i3, r4, o3, e3, f3, c3, s3), d3 = y3.__e, y3.ref && h3.ref != y3.ref && (h3.ref && V(h3.ref, null, y3), s3.push(y3.ref, y3.__c || d3, y3)), null == w3 && null != d3 && (w3 = d3), 4 & y3.__u || h3.__k === y3.__k ? f3 = A(y3, f3, n2) : "function" == typeof y3.type && void 0 !== _3 ? f3 = _3 : d3 && (f3 = d3.nextSibling), y3.__u &= -7);
  return u3.__e = w3, f3;
}
function I(n2, l3, u3, t3, i3) {
  ...
  if (a3)
    for (r4 = 0; r4 < s3; r4++)
      null != (e3 = u3[r4]) && 0 == (2 & e3.__u) && (e3.__e == t3 && (t3 = C(e3)), q(e3, e3));
  return t3;
}
function A(n2, l3, u3) {
  var t3, i3;
...
function F(n2, l3, u3, t3, i3) {
  ...
  n:
    if ("style" == l3)
      ...
      r4 = l3 != (l3 = l3.replace(f, "$1")), l3 = l3.toLowerCase() in n2 || "onFocusOut" == l3 || "onFocusIn" == l3 ? l3.toLowerCase().slice(2) : l3.slice(2), n2.l || (n2.l = {}), n2.l[l3 + r4] = u3, u3 ? t3 ? u3.u = t3.u : (u3.u = c, n2.addEventListener(l3, r4 ? a : s, r4)) : n2.removeEventListener(l3, r4 ? a : s, r4);
    else {
...
function j(n2, u3, t3, i3, r4, o3, e3, f3, c3, s3) {
  ...
  n:
    if ("function" == typeof F3)
      ...
      null == o3 && u3.__v == t3.__v ? (u3.__k = t3.__k, u3.__e = t3.__e) : f3 = u3.__e = N(t3.__e, u3, t3, i3, r4, o3, e3, c3, s3);
...
function N(u3, t3, i3, r4, o3, e3, f3, c3, s3) {
  ...
  if (null === x3)
    ...
    else if (v3 && (u3.innerHTML = ""), $(u3, d(y3) ? y3 : [y3], t3, i3, r4, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o3, e3, f3, e3 ? e3[0] : i3.__k && C(i3, 0), c3, s3), null != e3)
      for (a3 = e3.length; a3--; )
        _(e3[a3]);
...
function q(n2, u3, t3) {
  ...
  if (i3 = n2.__k)
    for (r4 = 0; r4 < i3.length; r4++)
      i3[r4] && q(i3[r4], u3, t3 || "function" != typeof n2.type);
...
function G(l3, u3, t3) {
  ...
  for (o3 in l3.type && l3.type.defaultProps && (e3 = l3.type.defaultProps), u3)
    "key" == o3 ? i3 = u3[o3] : "ref" == o3 ? r4 = u3[o3] : f3[o3] = void 0 === u3[o3] && void 0 !== e3 ? e3[o3] : u3[o3];
...
//# sourceMappingURL=dist-K2X2TJCK.js.map
