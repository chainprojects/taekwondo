...
function __spreadArrays() {
  ...
  for (var r2 = Array(s2), k4 = 0, i2 = 0; i2 < il; i2++)
    for (var a = arguments[i2], j3 = 0, jl = a.length; j3 < jl; j3++, k4++)
      r2[k4] = a[j3];
  return r2;
}
function __await(v2) {
    ...
    function hashBlocks(w2, v2, p2, pos, len) {
      while (len >= 64) {
        ...
        for (var i2 = 0; i2 < 16; i2++) {
          var j3 = pos + i2 * 4;
          w2[i2] = binary_1.readUint32BE(p2, j3);
        }
        ...
        for (var i2 = 0; i2 < 64; i2++) {
          var t1 = (((e2 >>> 6 | e2 << 32 - 6) ^ (e2 >>> 11 | e2 << 32 - 11) ^ (e2 >>> 25 | e2 << 32 - 25)) + (e2 & f2 ^ ~e2 & g2) | 0) + (h3 + (K3[i2] + w2[i2] | 0) | 0) | 0;
          var t2 = ((a >>> 2 | a << 32 - 2) ^ (a >>> 13 | a << 32 - 13) ^ (a >>> 22 | a << 32 - 22)) + (a & b2 ^ a & c3 ^ b2 & c3) | 0;
          h3 = g2;
          g2 = f2;
          f2 = e2;
          e2 = d2 + t1 | 0;
...
var require_x25519 = __commonJS({
  "node_modules/@stablelib/x25519/lib/x25519.js"(exports) {
    ...
    function scalarMult(n3, p2) {
      ...
      const a = gf(), b2 = gf(), c3 = gf(), d2 = gf(), e2 = gf(), f2 = gf();
...
function Cn(t, e2, n3, r2) {
  ...
  const o2 = BigInt(32), s2 = BigInt(4294967295), a = Number(n3 >> o2 & s2), u = Number(n3 & s2), i2 = r2 ? 4 : 0, D2 = r2 ? 0 : 4;
...
var Jn = class extends An {
  ...
  get() {
    const { Ah: e2, Al: n3, Bh: r2, Bl: o2, Ch: s2, Cl: a, Dh: u, Dl: i2, Eh: D2, El: c3, Fh: l3, Fl: p2, Gh: w2, Gl: h3, Hh: g2, Hl: S2 } = this;
    return [e2, n3, r2, o2, s2, a, u, i2, D2, c3, l3, p2, w2, h3, g2, S2];
  }
  set(e2, n3, r2, o2, s2, a, u, i2, D2, c3, l3, p2, w2, h3, g2, S2) {
    this.Ah = e2 | 0, this.Al = n3 | 0, this.Bh = r2 | 0, this.Bl = o2 | 0, this.Ch = s2 | 0, this.Cl = a | 0, this.Dh = u | 0, this.Dl = i2 | 0, this.Eh = D2 | 0, this.El = c3 | 0, this.Fh = l3 | 0, this.Fl = p2 | 0, this.Gh = w2 | 0, this.Gl = h3 | 0, this.Hh = g2 | 0, this.Hl = S2 | 0;
  }
  process(e2, n3) {
    for (let d2 = 0; d2 < 16; d2++, n3 += 4)
      P[d2] = e2.getUint32(n3), Q[d2] = e2.getUint32(n3 += 4);
    for (let d2 = 16; d2 < 80; d2++) {
      const m2 = P[d2 - 15] | 0, F = Q[d2 - 15] | 0, q = x3.rotrSH(m2, F, 1) ^ x3.rotrSH(m2, F, 8) ^ x3.shrSH(m2, F, 7), z3 = x3.rotrSL(m2, F, 1) ^ x3.rotrSL(m2, F, 8) ^ x3.shrSL(m2, F, 7), I2 = P[d2 - 2] | 0, O3 = Q[d2 - 2] | 0, ot = x3.rotrSH(I2, O3, 19) ^ x3.rotrBH(I2, O3, 61) ^ x3.shrSH(I2, O3, 6), tt = x3.rotrSL(I2, O3, 19) ^ x3.rotrBL(I2, O3, 61) ^ x3.shrSL(I2, O3, 6), st = x3.add4L(z3, tt, Q[d2 - 7], Q[d2 - 16]), at = x3.add4H(st, q, ot, P[d2 - 7], P[d2 - 16]);
      P[d2] = at | 0, Q[d2] = st | 0;
    }
    let { Ah: r2, Al: o2, Bh: s2, Bl: a, Ch: u, Cl: i2, Dh: D2, Dl: c3, Eh: l3, El: p2, Fh: w2, Fl: h3, Gh: g2, Gl: S2, Hh: v2, Hl: L2 } = this;
    for (let d2 = 0; d2 < 80; d2++) {
      const m2 = x3.rotrSH(l3, p2, 14) ^ x3.rotrSH(l3, p2, 18) ^ x3.rotrBH(l3, p2, 41), F = x3.rotrSL(l3, p2, 14) ^ x3.rotrSL(l3, p2, 18) ^ x3.rotrBL(l3, p2, 41), q = l3 & w2 ^ ~l3 & g2, z3 = p2 & h3 ^ ~p2 & S2, I2 = x3.add5L(L2, F, z3, Yn[d2], Q[d2]), O3 = x3.add5H(I2, v2, m2, q, Vn[d2], P[d2]), ot = I2 | 0, tt = x3.rotrSH(r2, o2, 28) ^ x3.rotrBH(r2, o2, 34) ^ x3.rotrBH(r2, o2, 39), st = x3.rotrSL(r2, o2, 28) ^ x3.rotrBL(r2, o2, 34) ^ x3.rotrBL(r2, o2, 39), at = r2 & s2 ^ r2 & u ^ s2 & u, Ct = o2 & a ^ o2 & i2 ^ a & i2;
      v2 = g2 | 0, L2 = S2 | 0, g2 = w2 | 0, S2 = h3 | 0, w2 = l3 | 0, h3 = p2 | 0, { h: l3, l: p2 } = x3.add(D2 | 0, c3 | 0, O3 | 0, ot | 0), D2 = u | 0, c3 = i2 | 0, u = s2 | 0, i2 = a | 0, s2 = r2 | 0, a = o2 | 0;
      const At = x3.add3L(ot, st, Ct);
      r2 = x3.add3H(At, O3, tt, at), o2 = At | 0;
    }
    ({ h: r2, l: o2 } = x3.add(this.Ah | 0, this.Al | 0, r2 | 0, o2 | 0)), { h: s2, l: a } = x3.add(this.Bh | 0, this.Bl | 0, s2 | 0, a | 0), { h: u, l: i2 } = x3.add(this.Ch | 0, this.Cl | 0, u | 0, i2 | 0), { h: D2, l: c3 } = x3.add(this.Dh | 0, this.Dl | 0, D2 | 0, c3 | 0), { h: l3, l: p2 } = x3.add(this.Eh | 0, this.El | 0, l3 | 0, p2 | 0), { h: w2, l: h3 } = x3.add(this.Fh | 0, this.Fl | 0, w2 | 0, h3 | 0), { h: g2, l: S2 } = x3.add(this.Gh | 0, this.Gl | 0, g2 | 0, S2 | 0), { h: v2, l: L2 } = x3.add(this.Hh | 0, this.Hl | 0, v2 | 0, L2 | 0), this.set(r2, o2, s2, a, u, i2, D2, c3, l3, p2, w2, h3, g2, S2, v2, L2);
  }
  roundClean() {
    P.fill(0), Q.fill(0);
  }
...
function or(t, e2, n3) {
  ...
  let r2 = N2;
  for (; e2 > M; )
    e2 & N2 && (r2 = r2 * t % n3), t = t * t % n3, e2 >>= N2;
  return r2;
}
function J(t, e2, n3) {
  let r2 = t;
...
function Ae(t, e2) {
  ...
  let n3 = H(t, e2), r2 = e2, o2 = M, s2 = N2;
  for (; n3 !== M; ) {
    const u = r2 / n3, i2 = r2 % n3, D2 = o2 - s2 * u;
    r2 = n3, n3 = i2, o2 = s2, s2 = D2;
  }
  if (r2 !== N2)
...
function sr(t) {
  const e2 = (t - N2) / nt;
  let n3, r2, o2;
  for (n3 = t - N2, r2 = 0; n3 % nt === M; n3 /= nt, r2++)
    ;
  for (o2 = nt; o2 < t && or(o2, e2, t) !== t - N2; o2++)
    if (o2 > 1e3)
      throw new Error("Cannot find square root: likely non-prime P");
  if (r2 === 1) {
    const a = (t + N2) / Ht;
    return function(i2, D2) {
      const c3 = i2.pow(D2, a);
      if (!i2.eql(i2.sqr(c3), D2))
  ...
  return function(u, i2) {
    if (u.pow(i2, e2) === u.neg(u.ONE))
      throw new Error("Cannot find square root");
    let D2 = r2, c3 = u.pow(u.mul(u.ONE, o2), n3), l3 = u.pow(i2, s2), p2 = u.pow(i2, n3);
    for (; !u.eql(p2, u.ONE); ) {
      if (u.eql(p2, u.ZERO))
        return u.ZERO;
      let w2 = 1;
      for (let g2 = u.sqr(p2); w2 < D2 && !u.eql(g2, u.ONE); w2++)
        g2 = u.sqr(g2);
      const h3 = u.pow(c3, N2 << BigInt(D2 - w2 - 1));
      c3 = u.sqr(h3), l3 = u.mul(l3, h3), p2 = u.mul(p2, c3), D2 = w2;
    }
    return l3;
  };
}
function ir(t) {
  ...
  if (t % Ce === Be) {
    const e2 = (t - Be) / Ce;
    return function(r2, o2) {
      const s2 = r2.mul(o2, nt), a = r2.pow(s2, e2), u = r2.mul(o2, a), i2 = r2.mul(r2.mul(u, nt), a), D2 = r2.mul(u, r2.sub(i2, r2.ONE));
      if (!r2.eql(r2.sqr(D2), o2))
        throw new Error("Cannot find square root");
      return D2;
    };
  }
...
function fr(t, e2, n3) {
  ...
  let r2 = t.ONE, o2 = e2;
  for (; n3 > M; )
    n3 & N2 && (r2 = t.mul(r2, o2)), o2 = t.sqr(o2), n3 >>= N2;
  return r2;
}
function Dr(t, e2) {
...
function _e(t, e2, n3 = false, r2 = {}) {
  ...
  let a;
  const u = Object.freeze({ ORDER: t, isLE: n3, BITS: o2, BYTES: s2, MASK: er(o2), ZERO: M, ONE: N2, create: (i2) => H(i2, t), isValid: (i2) => {
    if (typeof i2 != "bigint")
      throw new Error("invalid field element: expected bigint, got " + typeof i2);
    return M <= i2 && i2 < t;
  }, is0: (i2) => i2 === M, isOdd: (i2) => (i2 & N2) === N2, neg: (i2) => H(-i2, t), eql: (i2, D2) => i2 === D2, sqr: (i2) => H(i2 * i2, t), add: (i2, D2) => H(i2 + D2, t), sub: (i2, D2) => H(i2 - D2, t), mul: (i2, D2) => H(i2 * D2, t), pow: (i2, D2) => fr(u, i2, D2), div: (i2, D2) => H(i2 * Ae(D2, t), t), sqrN: (i2) => i2 * i2, addN: (i2, D2) => i2 + D2, subN: (i2, D2) => i2 - D2, mulN: (i2, D2) => i2 * D2, inv: (i2) => Ae(i2, t), sqrt: r2.sqrt || ((i2) => (a || (a = ir(t)), a(u, i2))), invertBatch: (i2) => Dr(u, i2), cmov: (i2, D2, c3) => c3 ? D2 : i2, toBytes: (i2) => n3 ? Nt(i2, s2) : ge(i2, s2), fromBytes: (i2) => {
    if (i2.length !== s2)
...
function lr(t, e2) {
  return { constTimeNegate: zt, hasPrecomputes(n3) {
    ...
    const D2 = BigInt(2 ** n3 - 1), c3 = 2 ** n3, l3 = BigInt(n3);
    for (let p2 = 0; p2 < s2; p2++) {
      const w2 = p2 * a;
      let h3 = Number(o2 & D2);
      o2 >>= l3, h3 > a && (h3 -= c3, o2 += gt);
      const g2 = w2, S2 = w2 + Math.abs(h3) - 1, v2 = p2 % 2 !== 0, L2 = h3 < 0;
      h3 === 0 ? i2 = i2.add(zt(v2, r2[g2])) : u = u.add(zt(L2, r2[S2]));
    }
    return { p: u, f: i2 };
  }, wNAFUnsafe(n3, r2, o2, s2 = t.ZERO) {
    const { windows: a, windowSize: u } = Mt(n3, e2), i2 = BigInt(2 ** n3 - 1), D2 = 2 ** n3, c3 = BigInt(n3);
    for (let l3 = 0; l3 < a; l3++) {
      const p2 = l3 * u;
      if (o2 === Se)
        break;
      let w2 = Number(o2 & i2);
      if (o2 >>= c3, w2 > u && (w2 -= D2, o2 += gt), w2 === 0)
        continue;
      let h3 = r2[p2 + Math.abs(w2) - 1];
...
function br(t, e2, n3, r2) {
  ...
  const o2 = t.ZERO, s2 = tr(BigInt(n3.length)), a = s2 > 12 ? s2 - 3 : s2 > 4 ? s2 - 2 : s2 ? 2 : 1, u = (1 << a) - 1, i2 = new Array(u + 1).fill(o2), D2 = Math.floor((e2.BITS - 1) / a) * a;
  let c3 = o2;
  for (let l3 = D2; l3 >= 0; l3 -= a) {
    i2.fill(o2);
    for (let w2 = 0; w2 < r2.length; w2++) {
      const h3 = r2[w2], g2 = Number(h3 >> BigInt(l3) & BigInt(u));
      i2[g2] = i2[g2].add(n3[w2]);
    }
    let p2 = o2;
    for (let w2 = i2.length - 1, h3 = o2; w2 > 0; w2--)
      h3 = h3.add(i2[w2]), p2 = p2.add(h3);
    if (c3 = c3.add(p2), l3 !== 0)
...
function yr(t) {
  const e2 = gr(t), { Fp: n3, n: r2, prehash: o2, hash: s2, randomBytes: a, nByteLength: u, h: i2 } = e2, D2 = yt << BigInt(u * 8) - j2, c3 = n3.create, l3 = _e(e2.n, e2.nBitLength), p2 = e2.uvRatio || ((y3, f2) => {
    try {
      return { isValid: true, value: n3.sqrt(y3 * n3.inv(f2)) };
    } catch {
      return { isValid: false, value: G };
    }
  }), w2 = e2.adjustScalarBytes || ((y3) => y3), h3 = e2.domain || ((y3, f2, b2) => {
    if (Tt("phflag", b2), f2.length || b2)
      throw new Error("Contexts/pre-hash are not supported");
    return y3;
  });
  function g2(y3, f2) {
    ft("coordinate " + y3, f2, G, D2);
  }
  function S2(y3) {
    if (!(y3 instanceof d2))
  ...
  const v2 = xe((y3, f2) => {
    const { ex: b2, ey: E3, ez: B2 } = y3, C3 = y3.is0();
    f2 == null && (f2 = C3 ? wr : n3.inv(B2));
    const A2 = c3(b2 * f2), U2 = c3(E3 * f2), _3 = c3(B2 * f2);
    if (C3)
      return { x: G, y: j2 };
    if (_3 !== j2)
    ...
    const { ex: E3, ey: B2, ez: C3, et: A2 } = y3, U2 = c3(E3 * E3), _3 = c3(B2 * B2), T2 = c3(C3 * C3), $ = c3(T2 * T2), R = c3(U2 * f2), V = c3(T2 * c3(R + _3)), Y = c3($ + c3(b2 * c3(U2 * _3)));
    if (V !== Y)
  ...
  class d2 {
    constructor(f2, b2, E3, B2) {
      this.ex = f2, this.ey = b2, this.ez = E3, this.et = B2, g2("x", f2), g2("y", b2), g2("z", E3), g2("t", B2), Object.freeze(this);
    }
    get x() {
    ...
    static fromAffine(f2) {
      ...
      const { x: b2, y: E3 } = f2 || {};
      return g2("x", b2), g2("y", E3), new d2(b2, E3, j2, c3(b2 * E3));
    }
    static normalizeZ(f2) {
      const b2 = n3.invertBatch(f2.map((E3) => E3.ez));
      return f2.map((E3, B2) => E3.toAffine(b2[B2])).map(d2.fromAffine);
    }
    static msm(f2, b2) {
    ...
    equals(f2) {
      S2(f2);
      const { ex: b2, ey: E3, ez: B2 } = this, { ex: C3, ey: A2, ez: U2 } = f2, _3 = c3(b2 * U2), T2 = c3(C3 * B2), $ = c3(E3 * U2), R = c3(A2 * B2);
      return _3 === T2 && $ === R;
    }
    is0() {
    ...
    double() {
      const { a: f2 } = e2, { ex: b2, ey: E3, ez: B2 } = this, C3 = c3(b2 * b2), A2 = c3(E3 * E3), U2 = c3(yt * c3(B2 * B2)), _3 = c3(f2 * C3), T2 = b2 + E3, $ = c3(c3(T2 * T2) - C3 - A2), R = _3 + A2, V = R - U2, Y = _3 - A2, Z = c3($ * V), X = c3(R * Y), et = c3($ * Y), pt = c3(V * R);
      return new d2(Z, X, pt, et);
    }
    add(f2) {
      S2(f2);
      const { a: b2, d: E3 } = e2, { ex: B2, ey: C3, ez: A2, et: U2 } = this, { ex: _3, ey: T2, ez: $, et: R } = f2;
      if (b2 === BigInt(-1)) {
        const re = c3((C3 - B2) * (T2 + _3)), oe = c3((C3 + B2) * (T2 - _3)), mt = c3(oe - re);
        if (mt === G)
          return this.double();
      ...
      const V = c3(B2 * _3), Y = c3(C3 * T2), Z = c3(U2 * E3 * R), X = c3(A2 * $), et = c3((B2 + C3) * (_3 + T2) - V - Y), pt = X - Z, ee = X + Z, ne = c3(Y - b2 * V), un = c3(et * pt), cn = c3(ee * ne), an = c3(et * ne), fn = c3(pt * ee);
    ...
    multiply(f2) {
      ...
      return d2.normalizeZ([E3, B2])[0];
    }
    multiplyUnsafe(f2, b2 = d2.ZERO) {
      const E3 = f2;
      return ft("scalar", E3, G, r2), E3 === G ? F : this.is0() || E3 === j2 ? this : q.wNAFCachedUnsafe(this, E3, d2.normalizeZ, b2);
    }
    isSmallOrder() {
    ...
    static fromHex(f2, b2 = false) {
      ...
      A2[C3 - 1] = U2 & -129;
      const _3 = Et(A2), T2 = b2 ? D2 : n3.ORDER;
      ft("pointHex.y", _3, G, T2);
      const $ = c3(_3 * _3), R = c3($ - j2), V = c3(E3 * $ - B2);
      ...
      return et !== X && (Z = c3(-Z)), d2.fromAffine({ x: Z, y: _3 });
    }
    static fromPrivateKey(f2) {
      return O3(f2).point;
    }
    toRawBytes() {
      const { x: f2, y: b2 } = this.toAffine(), E3 = Nt(b2, n3.BYTES);
      return E3[E3.length - 1] |= f2 & j2 ? 128 : 0, E3;
    }
    toHex() {
      return Ft(this.toRawBytes());
    }
  }
  d2.BASE = new d2(e2.Gx, e2.Gy, j2, c3(e2.Gx * e2.Gy)), d2.ZERO = new d2(G, j2, j2, G);
  ...
  function O3(y3) {
    const f2 = n3.BYTES;
    y3 = W("private key", y3, f2);
    const b2 = W("hashed private key", s2(y3), 2 * f2), E3 = w2(b2.slice(0, f2)), B2 = b2.slice(f2, 2 * f2), C3 = I2(E3), A2 = m2.multiply(C3), U2 = A2.toRawBytes();
    return { head: E3, prefix: B2, scalar: C3, point: A2, pointBytes: U2 };
  }
  function ot(y3) {
    return O3(y3).pointBytes;
  }
  function tt(y3 = new Uint8Array(), ...f2) {
    const b2 = ye(...f2);
    return I2(s2(h3(b2, W("context", y3), !!o2)));
  }
  function st(y3, f2, b2 = {}) {
    y3 = W("message", y3), o2 && (y3 = o2(y3));
    const { prefix: E3, scalar: B2, pointBytes: C3 } = O3(f2), A2 = tt(b2.context, E3, y3), U2 = m2.multiply(A2).toRawBytes(), _3 = tt(b2.context, U2, C3, y3), T2 = z3(A2 + _3 * B2);
    ft("signature.s", T2, G, r2);
    const $ = ye(U2, Nt(T2, n3.BYTES));
    return W("result", $, n3.BYTES * 2);
  }
  const at = Er;
  function Ct(y3, f2, b2, E3 = at) {
    const { context: B2, zip215: C3 } = E3, A2 = n3.BYTES;
    y3 = W("signature", y3, 2 * A2), f2 = W("message", f2), b2 = W("publicKey", b2, A2), C3 !== void 0 && Tt("zip215", C3), o2 && (f2 = o2(f2));
    const U2 = Et(y3.slice(A2, 2 * A2));
    let _3, T2, $;
    try {
      _3 = d2.fromHex(b2, C3), T2 = d2.fromHex(y3.slice(0, A2), C3), $ = m2.multiplyUnsafe(U2);
    } catch {
      return false;
    }
    if (!C3 && _3.isSmallOrder())
      return false;
    const R = tt(B2, T2.toRawBytes(), _3.toRawBytes(), f2);
    return T2.add(_3.multiplyUnsafe(R)).subtract($).clearCofactor().equals(d2.ZERO);
  }
  return m2._setWindowSize(8), { CURVE: e2, getPublicKey: ot, sign: st, verify: Ct, ExtendedPoint: d2, utils: { getExtendedPublicKey: O3, randomPrivateKey: () => a(n3.BYTES), precompute(y3 = 8, f2 = d2.BASE) {
    return f2._setWindowSize(y3), f2.multiply(BigInt(3)), f2;
  } } };
}
BigInt(0), BigInt(1);
...
var Cr = BigInt(8);
function Ar(t) {
  const e2 = BigInt(10), n3 = BigInt(20), r2 = BigInt(40), o2 = BigInt(80), s2 = kt, u = t * t % s2 * t % s2, i2 = J(u, Te, s2) * u % s2, D2 = J(i2, xr, s2) * t % s2, c3 = J(D2, Br, s2) * D2 % s2, l3 = J(c3, e2, s2) * c3 % s2, p2 = J(l3, n3, s2) * l3 % s2, w2 = J(p2, r2, s2) * p2 % s2, h3 = J(w2, o2, s2) * w2 % s2, g2 = J(h3, o2, s2) * w2 % s2, S2 = J(g2, e2, s2) * c3 % s2;
...
function _r(t, e2) {
  ...
  let a = H(t * r2 * s2, n3);
  const u = H(e2 * a * a, n3), i2 = a, D2 = H(a * Ue, n3), c3 = u === t, l3 = u === H(-t, n3), p2 = u === H(-t * Ue, n3);
  return c3 && (a = i2), (l3 || p2) && (a = D2), ur(a, n3) && (a = H(-a, n3)), { isValid: c3 || l3, value: a };
}
...
function Ir(t, e2) {
  ...
  function l3(h3) {
    ...
    if (h3.length === 0)
      return "";
    for (var g2 = 0, S2 = 0, v2 = 0, L2 = h3.length; v2 !== L2 && h3[v2] === 0; )
      v2++, g2++;
    for (var d2 = (L2 - v2) * c3 + 1 >>> 0, m2 = new Uint8Array(d2); v2 !== L2; ) {
      for (var F = h3[v2], q = 0, z3 = d2 - 1; (F !== 0 || q < S2) && z3 !== -1; z3--, q++)
        F += 256 * m2[z3] >>> 0, m2[z3] = F % u >>> 0, F = F / u >>> 0;
      if (F !== 0)
    ...
    for (var I2 = d2 - S2; I2 !== d2 && m2[I2] === 0; )
      I2++;
    for (var O3 = i2.repeat(g2); I2 < d2; ++I2)
      O3 += t.charAt(m2[I2]);
    return O3;
  }
  function p2(h3) {
    ...
    var g2 = 0;
    if (h3[g2] !== " ") {
      for (var S2 = 0, v2 = 0; h3[g2] === i2; )
        S2++, g2++;
      for (var L2 = (h3.length - g2) * D2 + 1 >>> 0, d2 = new Uint8Array(L2); h3[g2]; ) {
        var m2 = n3[h3.charCodeAt(g2)];
        if (m2 === 255)
          return;
      ...
      if (h3[g2] !== " ") {
        for (var z3 = L2 - v2; z3 !== L2 && d2[z3] === 0; )
          z3++;
        for (var I2 = new Uint8Array(S2 + (L2 - z3)), O3 = S2; z3 !== L2; )
          I2[O3++] = d2[z3++];
        return I2;
      }
    }
  ...
  return { encode: l3, decodeUnsafe: p2, decode: w2 };
}
var Ur = Ir;
var Tr = Ur;
var He = (t) => {
...
var Mr = (t, e2, n3, r2) => {
  ...
  for (let c3 = 0; c3 < s2; ++c3) {
    ...
    i2 = i2 << n3 | l3, u += n3, u >= 8 && (u -= 8, a[D2++] = 255 & i2 >> u);
  }
  if (u >= n3 || 255 & i2 << 8 - u)
...
var k3 = ({ name: t, prefix: e2, bitsPerChar: n3, alphabet: r2 }) => Bt({ prefix: e2, name: t, encode(o2) {
  return qr(o2, r2, n3);
}, decode(o2) {
...
async function Qo(t, e2, n3, r2, o2 = (0, import_time.fromMiliseconds)(Date.now())) {
  const s2 = { alg: jt, typ: Zt }, a = Qe(r2.publicKey), u = o2 + n3, i2 = { iss: a, sub: t, aud: e2, iat: o2, exp: u }, D2 = rn({ header: s2, payload: i2 }), c3 = Rt.sign(D2, r2.secretKey.slice(0, 32));
...
*/
//# sourceMappingURL=chunk-7VSIBYBO.js.map
