...
var ModelViewer = (0, import_react7.lazy)(() => import("./ModelViewer-ad6f3167.browser.esm-HH53MGJG.js"));
var PlayButton = (_ref) => {
  let {
    onClick,
    isPlaying
  ...
  (0, import_react7.useEffect)(() => {
    ...
    const preloadEmbeddedWallet = async () => {
      ...
      if (hasEmbeddedWallet && restProps.clientId) {
        const {
          EmbeddedWalletSdk
        } = await import("./thirdweb-dev-wallets.browser.esm-LGWTN2MY.js");
...
function useRainbowWallet() {
  ...
  return (0, import_react7.useCallback)(async (connectOptions) => {
    const {
      rainbowWallet
    } = await import("./safeChainSlug-8dca7686.browser.esm-AQFAPOCB.js").then(function(n2) {
      return n2.R;
    });
...
function useFrameWallet() {
  ...
  return (0, import_react7.useCallback)(async (connectOptions) => {
    const {
      frameWallet
    } = await import("./frameWallet-8cc5e47c.browser.esm-JCMUJ2E5.js");
...
function useBloctoWallet() {
  ...
  return (0, import_react7.useCallback)(async (options) => {
    const {
      bloctoWallet
    } = await import("./bloctoWallet-4cc043fb.browser.esm-TE6LJ5DG.js");
...
function usePaperWallet() {
  ...
  return (0, import_react7.useCallback)(async (options) => {
    ...
    } = await import("./paperWallet-d2f9a4b2.browser.esm-YR2VHFKK.js");
...
function useWalletConnectV1() {
  ...
  return (0, import_react7.useCallback)(async (options) => {
    const {
      walletConnectV1
    } = await import("./walletConnectV1-7f7a98bb.browser.esm-YV7KNRIY.js");
...
//# sourceMappingURL=chunk-EJI2J7L7.js.map
