import {
  require_dist
} from "./chunk-TFDRZKQD.js";
import {
  hmac
} from "./chunk-TIZKSPBX.js";
import {
  keccak_224,
  keccak_256,
  keccak_384,
  keccak_512,
  u64_default
} from "./chunk-4HQ6F7ND.js";
import {
  HashMD,
  ZodIssueCode,
  sha256,
  z
} from "./chunk-ULOLDUZC.js";
import {
...
var isUint8Array = (data) => {
  var _a4, _b;
  return data instanceof Uint8Array || ((_a4 = data === null || data === void 0 ? void 0 : data.constructor) === null || _a4 === void 0 ? void 0 : _a4.name) === "Uint8Array" || ((_b = data === null || data === void 0 ? void 0 : data.constructor) === null || _b === void 0 ? void 0 : _b.name) === "Buffer";
};
...
var convert = (data, schema, dataPath, format2, oneOfPath = []) => {
  ...
  const object = data;
  if (Array.isArray(object) && (schema === null || schema === void 0 ? void 0 : schema.type) === "array" && ((_a4 = schema === null || schema === void 0 ? void 0 : schema.items) === null || _a4 === void 0 ? void 0 : _a4.type) === "object") {
    convertArray({
      value: object,
      schemaProp: schema,
      schema,
...
var Common = class _Common extends EventEmitter {
  ...
  nextHardforkBlockOrTimestamp(_hardfork) {
    var _a4, _b, _c;
    const hardfork = (_a4 = _hardfork) !== null && _a4 !== void 0 ? _a4 : this._hardfork;
    const hfs = this.hardforks();
...
var Web3Context = class _Web3Context extends Web3Config {
  constructor(providerOrContext) {
    ...
    this._requestManager = requestManager !== null && requestManager !== void 0 ? requestManager : new Web3RequestManager(provider, (_a4 = config === null || config === void 0 ? void 0 : config.enableExperimentalFeatures) === null || _a4 === void 0 ? void 0 : _a4.useSubscriptionWhenCheckingBlockTimeout, requestManagerMiddleware);
...
function decodeSignedTransaction(encodedSignedTransaction, returnFormat, options = {
  ...
  return {
    ...
    tx: formatTransaction(Object.assign(Object.assign({}, TransactionFactory.fromSerializedData(hexToBytes2(encodedSignedTransaction)).toJSON()), { hash: bytesToHex2(keccak256Wrapper(hexToBytes2(encodedSignedTransaction))), type: detectRawTransactionType(hexToBytes2(encodedSignedTransaction)) }), returnFormat, {
...
function getEip1559GasPricing(transaction, web3Context, returnFormat) {
  return __awaiter20(this, void 0, void 0, function* () {
    ...
    if (!isNullish(transaction.gasPrice) || !isNullish(gasPrice)) {
      const convertedTransactionGasPrice = format({ format: "uint" }, (_a4 = transaction.gasPrice) !== null && _a4 !== void 0 ? _a4 : gasPrice, returnFormat);
      return {
...
var getTransactionNonce = (web3Context_1, address_1, ...args_1) => __awaiter21(void 0, [web3Context_1, address_1, ...args_1], void 0, function* (web3Context, address, returnFormat = web3Context.defaultReturnFormat) {
...
function encodeString(_param, input) {
  ...
  const bytes = utf8ToBytes2(input);
...
function getRevertReason(web3Context_1, transaction_1, contractAbi_1) {
  return __awaiter27(this, arguments, void 0, function* (web3Context, transaction, contractAbi, returnFormat = web3Context.defaultReturnFormat) {
    try {
...
var SendTxHelper = class {
  ...
  populateGasPrice(_a4) {
    return __awaiter29(this, arguments, void 0, function* ({ transactionFormatted, transaction }) {
      var _b;
  ...
  signAndSend(_a4) {
    return __awaiter29(this, arguments, void 0, function* ({ wallet, tx }) {
      if (wallet) {
  ...
  handleError(_a4) {
    return __awaiter29(this, arguments, void 0, function* ({ error, tx }) {
      var _b;
      let _error = error;
  ...
  handleResolve(_a4) {
    return __awaiter29(this, arguments, void 0, function* ({ receipt, tx }) {
      var _b, _c, _d;
...
var getProtocolVersion2 = (web3Context) => __awaiter30(void 0, void 0, void 0, function* () {
...
var getCoinbase2 = (web3Context) => __awaiter30(void 0, void 0, void 0, function* () {
  return eth_rpc_methods_exports.getCoinbase(web3Context.requestManager);
});
var isMining = (web3Context) => __awaiter30(void 0, void 0, void 0, function* () {
...
function getBalance2(web3Context_1, address_1) {
  return __awaiter30(this, arguments, void 0, function* (web3Context, address, blockNumber = web3Context.defaultBlock, returnFormat) {
...
function getStorageAt2(web3Context_1, address_1, storageSlot_1) {
  return __awaiter30(this, arguments, void 0, function* (web3Context, address, storageSlot, blockNumber = web3Context.defaultBlock, returnFormat) {
...
function getBlock(web3Context_1) {
  return __awaiter30(this, arguments, void 0, function* (web3Context, block = web3Context.defaultBlock, hydrated = false, returnFormat) {
    var _a4;
    let response;
    if (isBytes(block)) {
    ...
    if (!isNullish(res)) {
      const result = Object.assign(Object.assign({}, res), { transactions: (_a4 = res.transactions) !== null && _a4 !== void 0 ? _a4 : [] });
      return result;
    }
    return res;
  });
...
function getBlockTransactionCount(web3Context_1) {
  return __awaiter30(this, arguments, void 0, function* (web3Context, block = web3Context.defaultBlock, returnFormat) {
    let response;
    if (isBytes(block)) {
      const blockHashFormatted = format({ format: "bytes32" }, block, ETH_DATA_FORMAT);
...
function getUncle(web3Context_1) {
  return __awaiter30(this, arguments, void 0, function* (web3Context, block = web3Context.defaultBlock, uncleIndex, returnFormat) {
...
function getTransaction(web3Context_1, transactionHash_1) {
  return __awaiter30(this, arguments, void 0, function* (web3Context, transactionHash, returnFormat = web3Context.defaultReturnFormat) {
...
function getTransactionFromBlock(web3Context_1) {
  return __awaiter30(this, arguments, void 0, function* (web3Context, block = web3Context.defaultBlock, transactionIndex, returnFormat) {
...
function sign4(web3Context_1, message_1, addressOrIndex_1) {
  return __awaiter30(this, arguments, void 0, function* (web3Context, message, addressOrIndex, returnFormat = web3Context.defaultReturnFormat) {
    var _a4;
...
function signTransaction4(web3Context_1, transaction_1) {
  return __awaiter30(this, arguments, void 0, function* (web3Context, transaction, returnFormat = web3Context.defaultReturnFormat) {
...
function call2(web3Context_1, transaction_1) {
  return __awaiter30(this, arguments, void 0, function* (web3Context, transaction, blockNumber = web3Context.defaultBlock, returnFormat = web3Context.defaultReturnFormat) {
    const blockNumberFormatted = isBlockTag(blockNumber) ? blockNumber : format({ format: "uint" }, blockNumber, ETH_DATA_FORMAT);
...
function estimateGas2(web3Context_1, transaction_1) {
  return __awaiter30(this, arguments, void 0, function* (web3Context, transaction, blockNumber = web3Context.defaultBlock, returnFormat) {
...
function getProof2(web3Context_1, address_1, storageKeys_1) {
  return __awaiter30(this, arguments, void 0, function* (web3Context, address, storageKeys, blockNumber = web3Context.defaultBlock, returnFormat) {
...
function getFeeHistory2(web3Context_1, blockCount_1) {
  return __awaiter30(this, arguments, void 0, function* (web3Context, blockCount, newestBlock = web3Context.defaultBlock, rewardPercentiles, returnFormat) {
...
var Web3Eth = class _Web3Eth extends Web3Context {
  ...
  getHashrate(returnFormat) {
    return __awaiter32(this, void 0, void 0, function* () {
      ...
      if (returnFormat === void 0) {
        returnFormat = (_a4 = this.defaultReturnFormat) !== null && _a4 !== void 0 ? _a4 : DEFAULT_RETURN_FORMAT;
      }
   ...
   */
  getHashRate() {
    return __awaiter32(this, arguments, void 0, function* (returnFormat = this.defaultReturnFormat) {
   ...
   */
  calculateFeeData() {
    return __awaiter32(this, arguments, void 0, function* (baseFeePerGasFactor = BigInt(2), alternativeMaxPriorityFeePerGas = ethUnitMap.Gwei) {
      var _a4;
  ...
  getBalance(address_1) {
    return __awaiter32(this, arguments, void 0, function* (address, blockNumber = this.defaultBlock, returnFormat = this.defaultReturnFormat) {
  ...
  getStorageAt(address_1, storageSlot_1) {
    return __awaiter32(this, arguments, void 0, function* (address, storageSlot, blockNumber = this.defaultBlock, returnFormat = this.defaultReturnFormat) {
   ...
   */
  getBlock() {
    return __awaiter32(this, arguments, void 0, function* (block = this.defaultBlock, hydrated = false, returnFormat = this.defaultReturnFormat) {
  ...
  getBlockTransactionCount() {
    return __awaiter32(this, arguments, void 0, function* (block = this.defaultBlock, returnFormat = this.defaultReturnFormat) {
   ...
   */
  getUncle() {
    return __awaiter32(this, arguments, void 0, function* (block = this.defaultBlock, uncleIndex, returnFormat = this.defaultReturnFormat) {
  ...
  getTransaction(transactionHash_1) {
    return __awaiter32(this, arguments, void 0, function* (transactionHash, returnFormat = this.defaultReturnFormat) {
  ...
  getTransactionFromBlock() {
    return __awaiter32(this, arguments, void 0, function* (block = this.defaultBlock, transactionIndex, returnFormat = this.defaultReturnFormat) {
  ...
  sign(message_1, addressOrIndex_1) {
    return __awaiter32(this, arguments, void 0, function* (message, addressOrIndex, returnFormat = this.defaultReturnFormat) {
  ...
  signTransaction(transaction_1) {
    return __awaiter32(this, arguments, void 0, function* (transaction, returnFormat = this.defaultReturnFormat) {
   ...
   */
  call(transaction_1) {
    return __awaiter32(this, arguments, void 0, function* (transaction, blockNumber = this.defaultBlock, returnFormat = this.defaultReturnFormat) {
  ...
  getPastLogs(filter_1) {
    return __awaiter32(this, arguments, void 0, function* (filter, returnFormat = this.defaultReturnFormat) {
  ...
  getProof(address_1, storageKeys_1) {
    return __awaiter32(this, arguments, void 0, function* (address, storageKeys, blockNumber = this.defaultBlock, returnFormat = this.defaultReturnFormat) {
  ...
  getFeeHistory(blockCount_1) {
    return __awaiter32(this, arguments, void 0, function* (blockCount, newestBlock = this.defaultBlock, rewardPercentiles, returnFormat = this.defaultReturnFormat) {
  ...
  getFilterChanges(filterIdentifier_1) {
    return __awaiter32(this, arguments, void 0, function* (filterIdentifier, returnFormat = this.defaultReturnFormat) {
...
var prepareTransactionForSigning = (transaction_1, web3Context_1, privateKey_1, ...args_1) => __awaiter33(void 0, [transaction_1, web3Context_1, privateKey_1, ...args_1], void 0, function* (transaction, web3Context, privateKey, fillGasPrice = false, fillGasLimit = true) {
...
function encode(input) {
  if (Array.isArray(input)) {
    ...
    return concatBytes3(encodeLength(outputLength, 192), ...output);
  }
...
var DeployerMethodClass = class {
  ...
  populateTransaction(txOptions) {
    var _a4, _b;
    const modifiedContractOptions = Object.assign(Object.assign({}, this.contractOptions), { from: (_b = (_a4 = this.contractOptions.from) !== null && _a4 !== void 0 ? _a4 : this.parent.defaultAccount) !== null && _b !== void 0 ? _b : void 0 });
  ...
  calculateDeployParams() {
    ...
    const _input = format({ format: "bytes" }, (_b = (_a4 = this.deployOptions) === null || _a4 === void 0 ? void 0 : _a4.input) !== null && _b !== void 0 ? _b : this.parent.options.input, DEFAULT_RETURN_FORMAT);
  ...
  estimateGas(options_1) {
    return __awaiter34(this, arguments, void 0, function* (options, returnFormat = this.parent.defaultReturnFormat) {
      const modifiedOptions = Object.assign({}, options);
...
var ContractSubscriptionManager = class extends Web3SubscriptionManager {
  ...
  subscribe(name_1, args_1) {
    ...
    return __awaiter35(this, arguments, void 0, function* (name2, args, returnFormat = DEFAULT_RETURN_FORMAT) {
...
var Contract = class _Contract extends Web3Context {
    ...
    for (const a of functionsAbi) {
      ...
      if (isAbiFunctionFragment(abi)) {
        ...
        this._overloadedMethodAbis.set(abi.name, [
          ...(_a4 = this._overloadedMethodAbis.get(abi.name)) !== null && _a4 !== void 0 ? _a4 : [],
          abi
        ]);
  ...
  _createContractMethod(abiArr, errorsAbis, exact = false) {
    ...
    return (...params) => {
      var _a4, _b, _c;
      let abiParams;
      const abis = (_b = exact ? (_a4 = this._overloadedMethodAbis.get(abi.name)) === null || _a4 === void 0 ? void 0 : _a4.filter((_abi) => _abi.signature === abi.signature) : this._overloadedMethodAbis.get(abi.name)) !== null && _b !== void 0 ? _b : [];
	...
	The first one will be used: ${methodAbi.methodNameWithInputs}`);
      ...
      const methods = {
        arguments: abiParams,
        call: (options, block) => __awaiter36(this, void 0, void 0, function* () {
        ...
        populateTransaction: (options, contractOptions) => {
          ...
          modifiedContractOptions = Object.assign(Object.assign({}, modifiedContractOptions), { input: void 0, from: (_b2 = (_a5 = modifiedContractOptions === null || modifiedContractOptions === void 0 ? void 0 : modifiedContractOptions.from) !== null && _a5 !== void 0 ? _a5 : this.defaultAccount) !== null && _b2 !== void 0 ? _b2 : void 0 });
          const tx = getSendTxParams({
            abi,
            params,
        ...
        estimateGas: (options_1, ...args_1) => __awaiter36(this, [options_1, ...args_1], void 0, function* (options, returnFormat = this.defaultReturnFormat) {
        ...
        createAccessList: (options, block) => __awaiter36(this, void 0, void 0, function* () {
  ...
  contractMethodEstimateGas(_a4) {
    return __awaiter36(this, arguments, void 0, function* ({ abi, params, returnFormat, options, contractOptions }) {
...
var getAccounts3 = (requestManager) => __awaiter40(void 0, void 0, void 0, function* () {
  const result = yield personal_rpc_methods_exports.getAccounts(requestManager);
  return result.map(toChecksumAddress);
});
var newAccount2 = (requestManager, password) => __awaiter40(void 0, void 0, void 0, function* () {
...
var unlockAccount2 = (requestManager, address, password, unlockDuration) => __awaiter40(void 0, void 0, void 0, function* () {
...
var lockAccount2 = (requestManager, address) => __awaiter40(void 0, void 0, void 0, function* () {
  validator.validate(["address"], [address]);
  return personal_rpc_methods_exports.lockAccount(requestManager, address);
});
var importRawKey2 = (requestManager, keyData, passphrase) => __awaiter40(void 0, void 0, void 0, function* () {
...
var sendTransaction4 = (requestManager, tx, passphrase, config) => __awaiter40(void 0, void 0, void 0, function* () {
...
var signTransaction5 = (requestManager, tx, passphrase, config) => __awaiter40(void 0, void 0, void 0, function* () {
  const formattedTx = formatTransaction(tx, ETH_DATA_FORMAT, {
    transactionSchema: config === null || config === void 0 ? void 0 : config.customTransactionSchema
  });
  return personal_rpc_methods_exports.signTransaction(requestManager, formattedTx, passphrase);
});
var sign5 = (requestManager, data, address, passphrase) => __awaiter40(void 0, void 0, void 0, function* () {
...
var ecRecover2 = (requestManager, signedData, signature) => __awaiter40(void 0, void 0, void 0, function* () {
...
var initAccountsForContext = (context) => {
  const signTransactionWithContext = (transaction, privateKey) => __awaiter42(void 0, void 0, void 0, function* () {
  ...
  const privateKeyToAccountWithContext = (privateKey) => {
    ...
    return Object.assign(Object.assign({}, account), { signTransaction: (transaction) => __awaiter42(void 0, void 0, void 0, function* () {
      return signTransactionWithContext(transaction, account.privateKey);
    }) });
  };
  const decryptWithContext = (keystore, password, options) => __awaiter42(void 0, void 0, void 0, function* () {
    var _a4;
