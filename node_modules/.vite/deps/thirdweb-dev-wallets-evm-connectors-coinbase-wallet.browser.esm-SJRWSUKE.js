...
import {
  WagmiConnector
} from "./chunk-WBV72VUR.js";
import {
  getValidPublicRPCUrl
} from "./chunk-T7FWIBI6.js";
import {
  normalizeChainId
...
var CoinbaseWalletConnector = class extends WagmiConnector {
  ...
  async getProvider() {
    var _a;
    if (!this._provider) {
      let CoinbaseWalletSDK = (await import("./dist-K2X2TJCK.js")).default;
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-coinbase-wallet.browser.esm-SJRWSUKE.js.map
